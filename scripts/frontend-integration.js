 ...
 * This file demonstrates how to integrate Fluxveil with a web frontend
 */

// For React/Vue/Angular applications
export class FluxveilClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FluxveilClient(provider, contractAddress);
